...
Use está [Hoja de referencia](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf) como ayuda para elaborar reportes Rmarkdown.
...
Abra el archivo *Rmarkdown_example.Rmd* disponible en Rstudio.cloud y revise su estructura.   
...
knitr::include_graphics("Fig_1_Setup_Rmarkdown.png")
```

Luego guarde inmediatamente su script como **script_Rmarkdown_nombre_apellido.Rmd**.  
...
En el primer bloque de códigos o **chunk** asegúrese de que los comandos están configurados de la siguiente manera *knitr::opts_chunk$set(echo = TRUE)*. Luego a modo de prueba, cargue el paquete **stats** usando la función library().
...
En uno de los bloques de códigos que creo anteriormente escriba los comandos necesarios para replicar la siguiente figura. Busque en google como añadir colores a un plot, como cambiar los símbolos con los argumentos **col=**, **bg=**, **pch=** y **cex=**. Puede agregar la leyenda de la figura usando el argumento **fig.cap=""** dentro de la primera línea del bloque de códigos.

```{r, , echo=FALSE, fig.cap="Demanda bioquímica de oxigeno"}
