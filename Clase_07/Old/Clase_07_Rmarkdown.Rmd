...
- Escribir un código de programación usando sintaxis de Rmarkdown.

- Elaborar reporte html con Rmarkdown.
...
- Escribir códigos de programación usando sintaxis de Rmarkdown.

- Elaborar diferentes reporte dinámico en formato html.
