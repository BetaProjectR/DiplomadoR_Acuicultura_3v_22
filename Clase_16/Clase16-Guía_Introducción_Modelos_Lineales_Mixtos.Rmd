---
title: "Clase 16 - Guía Modelos Lineales Mixtos"
...
Elabore un documento .Rmd y configure su reporte para exportar en .htlm. Instale solo las librerías que utilice para el análisis de los datos.
...
### **Ejercicio 2.** Exploratorio set de datos UGELVIK_et_al_2017.xlsx
...
**a).** Ajuste un modelo donde la variable respuesta sea **rc_area_damage** y como efectos fijos del modelo las variables **Status**, **Nbfemales** y **DaysPI**. Use la función **lm()**, **summary()**. 
...
**a).** Ajuste un modelo donde la variable respuesta sea **rc_area_damage**, como efectos fijos del modelo las variables **Status**, **Nbfemales** y **DaysPI** y como efecto aleatorio  **Tank**. Use la función **lmer()**, **summary()**. 
